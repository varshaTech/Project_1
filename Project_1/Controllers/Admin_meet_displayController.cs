...
{
    public class Admin_meet_displayController : Controller
    {
        private Proj1_DBEntitiesContext db = new Proj1_DBEntitiesContext();

        // GET: Admin_meet_display
        public ActionResult Index(int MeetID)
        {
            List<Meeting_Details> meet = db.Meeting_Details.Where(meets => meets.ID == MeetID).ToList();
            return View(meet);
        }

        // GET: Admin_meet_display/Details/5
        public ActionResult Details(int id)
        {
            Meeting_Details meetings = db.Meeting_Details.Single(x => x.M_ID == id);
            return View(meetings);
        }

        // GET: Admin_meet_display/Create
        ...
        // POST: Admin_meet_display/Create
        ...
        // POST: Admin_meet_display/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin_meet_display/Delete/5
        ...
        // POST: Admin_meet_display/Delete/5
